"""Synthetic tests for the volatility_bot_v3 engine (touch detection + one-shot
+ bet direction). No network.
  python volatility_bot_v3/engine.py
  python volatility_bot_v3/engine_test.py
"""
import sys
from pathlib import Path

sys.path.insert(0, str(Path(__file__).resolve().parents[1]))
from volatility_bot_v3.engine import (  # noqa: E402
