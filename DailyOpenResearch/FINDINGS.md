...
11. **Once price is 0.3 ADR from the open, it never comes back that day 41-42% of the time, on all three instruments.** At 13:00 UK with more than 0.5 ADR of travel, the close is back through the open only 6-15% of the time. The direction is set by then, but the probability of *further* progress from that point is still 50%.
