...
function acc() { return { n: 0, s: 0, ss: 0, tMfe: 0, tMae: 0, cMfe: 0, cMae: 0 }; }
function push(a, d, tM, tA, cM, cA) { a.n++; a.s += d; a.ss += d * d; a.tMfe += tM; a.tMae += tA; a.cMfe += cM; a.cMae += cA; }
function stats(a) {
  ...
  for (const day of days) {
    ...
    for (const t of day.touches) {
      ...
      for (let attempt = 0; attempt < 12; attempt++) {
        ...
        (A[fam] ??= acc());
        push(A[fam], (touchMfe - touchMae) - (cM - cA), touchMfe, touchMae, cM, cA);
        break;
      }
      ...
      for (let attempt = 0; attempt < 12; attempt++) {
        ...
        (B[fam] ??= acc());
        push(B[fam], (touchMfe - touchMae) - (cM - cA), touchMfe, touchMae, cM, cA);
        break;
      }
    }
  }
