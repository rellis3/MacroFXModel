#!/usr/bin/env python3
"""head_shoulders_scan_sweep.py — full pair-universe check + calendar IS/OOS
split for head & shoulders instances, using the shared
`pattern_sweep.run_sweep` core.

Usage:
  python AnalogML/head_shoulders_scan_sweep.py --pairs gbpjpy,eurusd,audjpy,usdjpy
  python AnalogML/head_shoulders_scan_sweep.py --all-pairs
"""
...
def main() -> None:
    ...
    run_sweep(pairs, args.timeframe, args.sl_pips, args.tp_r, args.cost,
             ...
             detect_fn=detect_head_shoulders)
