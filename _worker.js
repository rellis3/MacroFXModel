    ...
    try {
      ...
      if (path === '/api/kv/set' && request.method === 'POST') {
        ...
        try {
          ...
          const STATUS_KEYS = new Set(['regime_bot_status', 'gold_bot_status', 'gold_v2_status', 'regime_bot_v2_status', 'regime_bot_v7_status', 'dyn_anchor_status', 'macro_equity_bot_status', 'volatility_bot_status', 'range_line_bot_status']);
