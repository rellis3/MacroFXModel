...
`;
  ...
  <div class="chub-dd" id="chubDDlive">
    ...
    <div class="chub-menu">
      ...
      <a class="chub-item" href="drill.html" target="_blank" data-href="drill.html"><span class="ci-txt">🎯 The Drill</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('drill.html')" data-href="drill.html">☆</button></a>
      <a class="chub-item" href="market-view.html" target="_blank" data-href="market-view.html"><span class="ci-txt">🌐 Market View</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('market-view.html')" data-href="market-view.html">☆</button></a>
      <a class="chub-item" href="weekmap.html" target="_blank" data-href="weekmap.html"><span class="ci-txt">🗺 The Week, Scored</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('weekmap.html')" data-href="weekmap.html">☆</button></a>
      <a class="chub-item" href="rates.html" target="_blank" data-href="rates.html"><span class="ci-txt">📉 Rates &amp; Policy</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('rates.html')" data-href="rates.html">☆</button></a>
      <a class="chub-item" href="regime.html" target="_blank" data-href="regime.html"><span class="ci-txt">🧭 Regime</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('regime.html')" data-href="regime.html">☆</button></a>
      <a class="chub-item" href="evidence.html" target="_blank" data-href="evidence.html"><span class="ci-txt">📗 Evidence Book</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('evidence.html')" data-href="evidence.html">☆</button></a>
      ...
      <a class="chub-item" href="vol-forecast-v3.html" target="_blank" data-href="vol-forecast-v3.html"><span class="ci-txt">📐 Vol Forecast v3</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('vol-forecast-v3.html')" data-href="vol-forecast-v3.html">☆</button></a>
      ...
      <a class="chub-item" href="bot-audit.html" target="_blank" data-href="bot-audit.html"><span class="ci-txt">📉 Bot Audit (live tearsheet)</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('bot-audit.html')" data-href="bot-audit.html">☆</button></a>
  ...
  <div class="chub-dd" id="chubDDvol">
    ...
    <div class="chub-menu">
      ...
      <a class="chub-item" href="level-atlas-hl-signal-portfolio.html" target="_blank" data-href="level-atlas-hl-signal-portfolio.html"><span class="ci-txt">⏱ HL Delayed-Entry Portfolio (suspect)</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('level-atlas-hl-signal-portfolio.html')" data-href="level-atlas-hl-signal-portfolio.html">☆</button></a>
      ...
      <a class="chub-item" href="asia-fib-atlas-vote-portfolio.html" target="_blank" data-href="asia-fib-atlas-vote-portfolio.html"><span class="ci-txt">🧺 Asia/Monday Fib Vote Portfolio</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('asia-fib-atlas-vote-portfolio.html')" data-href="asia-fib-atlas-vote-portfolio.html">☆</button></a>
    </div>
  </div>
  ...
  <div class="chub-dd" id="chubDDresearch">
    ...
    <div class="chub-menu">
      <a class="chub-item" href="market-sense.html" target="_blank" data-href="market-sense.html"><span class="ci-txt">🧪 Market-Sense Studies</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('market-sense.html')" data-href="market-sense.html">☆</button></a>
      ...
      <a class="chub-item" href="event-response.html" target="_blank" data-href="event-response.html"><span class="ci-txt">📅 Event Response</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('event-response.html')" data-href="event-response.html">☆</button></a>
      ...
      <a class="chub-item" href="multi-spread-sleeve.html" target="_blank" data-href="multi-spread-sleeve.html"><span class="ci-txt">🎯 Multi-Spread Sleeve</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('multi-spread-sleeve.html')" data-href="multi-spread-sleeve.html">☆</button></a>
      ...
      <a class="chub-item" href="motif-alert-backtest.html" target="_blank" data-href="motif-alert-backtest.html"><span class="ci-txt">👀 Motif Alert BT</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('motif-alert-backtest.html')" data-href="motif-alert-backtest.html">☆</button></a>
  ...
  <div class="chub-dd" id="chubDDequity">
    ...
    <div class="chub-menu">
      ...
      <a class="chub-item" href="nasdaq-macro-lead.html" target="_blank" data-href="nasdaq-macro-lead.html"><span class="ci-txt">🧭 NQ Macro Lead</span><button class="chub-star" onclick="event.preventDefault();event.stopPropagation();chubToggleFav('nasdaq-macro-lead.html')" data-href="nasdaq-macro-lead.html">☆</button></a>
