...
export const SERVICES = [
  ...
  { id: 'nowcast', where: 'server', label: 'Inflation/GDP nowcasts (Cleveland Fed + GDPNow)',
    cadence: 'daily', cost: 'low', lean: false, on: true,
    feeds: '/api/nowcast -> today.html\'s third number next to consensus and actual. Two outside fetches a day. MD files/NOWCAST_TESTS.md records that N1 came back null and N2 insufficient, so this is context on the page, never a signal — off costs nothing but that context.' },
