...
export const S = {
  ...
  compassShowDiv:  false,  // overlay price-vs-spread regression-residual z-score on compass chart
  ...
  ifoData:         null,   // ifo Business Climate (Germany) — { series:[{month,value}], seed } — DAX macro T1
  ...
  garchForecast:   null,  // instruments map from /api/vol-forecast — { EURUSD: { hl_median, hl_75, ... }, ... }
