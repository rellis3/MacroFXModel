...
export const PANEL = [
  ...
  // plumbing: overnight money against the Fed's floor (IORB; IOER before 2021-07-29), and the backstops
  { id: 'plumb',   label: 'SOFR − floor',    derive: ['sofr', 'floor'], kind: 'bp' },
  { id: 'sofr99',  label: 'SOFR 99th − floor', derive: ['sofr99raw', 'floor'], kind: 'bp' },
  { id: 'effrfloor', label: 'EFFR − floor',  derive: ['effr', 'floor'], kind: 'bp' },
  { id: 'srf',     label: 'Repo backstop',   fred: 'RPONTSYD',     kind: 'bn' },
  { id: 'dw',      label: 'Discount window', fred: 'WLCFLPCL',     kind: 'bn', scale: 1 / 1000 },
  { id: 'sofr',    label: 'SOFR',            fred: 'SOFR',         kind: 'bp', hidden: true },
  { id: 'sofr99raw', label: 'SOFR 99th',     nyfed: 'sofr99',      kind: 'bp', hidden: true },
  { id: 'effr',    label: 'EFFR',            fred: 'EFFR',         kind: 'bp', hidden: true },
  { id: 'floor',   label: 'Floor (IORB/IOER)', splice: ['ioer', 'iorb', '2021-07-29'], kind: 'bp', hidden: true },
  { id: 'iorb',    label: 'IORB',            fred: 'IORB',         kind: 'bp', hidden: true },
  { id: 'ioer',    label: 'IOER',            fred: 'IOER',         kind: 'bp', hidden: true },
