...
export const GLOSSARY = [
  ...
  },
  {
    ...
    scale: 'Above 60% of one side underwater is a lot of pain; near 50% is nothing. It was tested as a squeeze setup and is not one: Tested 2026-09-13 on nine years of daily snapshots (analysis/squeeze_vol_study.mjs): days when the crowded side was mostly underwater were NOT wider than matched days, on any of four instruments, and the move went neither with nor against the crowd. Pain says who is losing today. It does not say what happens next.',
  ...
  {
    id: 'squeeze', term: 'Squeeze', aliases: ['short squeeze', 'liquidation'], section: 'lean', evidence: 'null',
    ...
    scale: 'The visible ingredients — a crowded side, mostly underwater — were tested against the next day\'s range and predict nothing: Tested 2026-09-13 on nine years of daily snapshots (analysis/squeeze_vol_study.mjs): days when the crowded side was mostly underwater were NOT wider than matched days, on any of four instruments, and the move went neither with nor against the crowd. Pain says who is losing today. It does not say what happens next.',
