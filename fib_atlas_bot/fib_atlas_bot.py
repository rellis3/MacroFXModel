...
# refresh, bot-config.html's Broker Symbols card) -- this bot's OWN MT5
# account (MetaQuotes-Demo) is a DIFFERENT broker than the one the
# _BROKER_OVERRIDE defaults above were copied from (Vote Atlas's
# OANDA_UK-Demo-1, confirmed 2026-09-26), so those defaults are an unverified
# guess here, not a fact. This override tier is how to correct a wrong guess
# without a code deploy -- same convention as volatility_bot_v2's own
