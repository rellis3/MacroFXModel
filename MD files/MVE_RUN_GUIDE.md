...
| 7 — book layer: factor audit of the spread sleeves (`MVE_BOOK_FACTOR_AUDIT.md`) | ✅ run on Railway 2026-09-22: sanity gate passed, **RELATIVE-VALUE** on 2Y / 10Y / combined (neutral OOS Sharpe 1.33 / 1.01 / 1.36 vs raw 1.02 / 0.58 / 0.98). Next: frozen forward paper tracker of the neutral combined book |
