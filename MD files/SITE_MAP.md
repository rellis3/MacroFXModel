...
| `asia-fib-atlas-vote-backtest.html` | Barrier-priced OOS trade backtest (real candles, entry/target/stop markers, full tearsheet, CSV exports) across all 26 pairs, Asia ladder + Monday-ladder sibling | 🔬 Research | 2026-08-27 | margin=2 (both proven dims agree) holds cross-instrument after a realistic concurrency cap; margin=1 (either alone) does not — see `LEGO_MODULES.md` §1aq |
